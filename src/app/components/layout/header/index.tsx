...
const Header = () => {
    ...
    href="/my-resume.pdf"
    download
    className="relative overflow-hidden cursor-pointer w-fit py-2 sm:py-3 md:py-5 px-4 sm:px-5 md:px-7 border border-pink-500 rounded-full group hover:bg-pink-500"
>
