          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col gap-7 sm:gap-12">
                ...
                <button
  type="submit"
  className="group relative overflow-hidden cursor-pointer w-fit 
             py-2 sm:py-3 md:py-5 px-4 sm:px-5 md:px-7 
             border border-pink-500 
             rounded-full 
             transition-all duration-300 
             hover:bg-pink-500"
>
  <span className="relative z-10 text-xl font-medium text-pink-500 
  ...
  href={"#!"}
  className="text-base lg:text-lg text-black font-normal border-b border-black pb-3 hover:text-pink-500 hover:border-pink-500 transition-colors duration-300"
>
  {value?.label}
</Link>
                    </div>
                  ...
                  return (
                    <div key={index}>
                      <Link
                        onClick={(e) => e.preventDefault()}
                        href={"#!"}
                        className="text-base lg:text-lg text-black font-normal border-b border-black pb-3 hover:text-primary hover:border-pink"
                      >
                        {value?.label}
                      </Link>
                    </div>
